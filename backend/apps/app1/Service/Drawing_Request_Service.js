...
const getalldrawingrequest_existingbyrequest_no = async (payload) => {
    const mysql =`
    SELECT 
        "Request_Utility_Existing_Drawing_Form".request_id,
        "Request_Utility_Existing_Drawing_Form".request_no,
    ...
    LEFT JOIN "Status" 
    ON "Status".status_no = "Request_Utility_Existing_Drawing_Form".status
    WHERE "Request_Utility_Existing_Drawing_Form".request_no = $1
...
const changeStatusrequest_existing = async (payload, request_status) => {
    const sql = `
...
module.exports = {
    ...
    getalldrawingrequest_existingbyrequest_no
};