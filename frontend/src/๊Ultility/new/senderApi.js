...
export const fetchdrawingSender = async () => {
    try {
      const response = await apiClient.get(`new/drawingSender/`); // Send the GET request to the server
...
export const postdrawingSender = async (payload) => {
    try {
      const response = await apiClient.post(`new/drawingSender/post/`, payload); // Send the GET request to the server
