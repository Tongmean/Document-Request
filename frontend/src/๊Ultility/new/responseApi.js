...
export const postdrawingResponse = async (payload) => {
    try {
      const response = await apiClient.post(`new/drawingResponse/post`, payload); // Send the GET request to the server
...
export const postdrawingresponseCheckform = async (payload) => {
  try {
    const response = await apiClient.post(`new/drawingResponse/checkform/post`, payload); // Send the GET request to the server
