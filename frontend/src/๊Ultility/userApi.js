...
export const postUserapi = async (payload) => {
    try {
      const response = await apiClient.post(`user/post`, payload); // Send the GET request to the server
...
export const getUserbyuser_id = async (payload) => {
    try {
      const response = await apiClient.post(`user/`, payload); // Send the GET request to the server
...
export const updatedUserapi = async (payload) => {
    try {
      const response = await apiClient.post(`user/update`, payload); // Send the GET request to the server
