...
const Drawingrequestexist = () => {
    ...
    const load = async () => {
      ...
      try {
          ...
          const response = await fetchDrawingrequest(); // Replace with actual data fetching logic
    ...
    const handleOnClick = () => {
      navigate('/exist/createdrawingrequest');
    };
    const handleCheck = (data) => {
      navigate(`/exist/createdrawingresponse/${data.request_id}`);
    };
    return (
    <div>
...
export default Drawingrequestexist;